...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link" href="#">Filmler</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Müzikler</a></li>
          <li class="nav-item"><a class="btn btn-outline-light ms-2" href="#">Giriş Yap</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <!-- Footer sitenin en altında yer alan iletişim bölümüdür. -->
  <footer class="text-center text-light py-4 bg-bordo">
    <p class="mb-0 small">&copy; 2025 Ravora. Tüm hakları saklıdır.</p>
  </footer>
